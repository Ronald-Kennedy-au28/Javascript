...
C. Wrote a setTimeout() function with a delay of 3 seconds to mock getting the username
 from the user
...
E. Called the callback function validateUsername() while passing in the username as the 
argument to it
*/
/**
 * Function to get the username from the database
 * @param {*} callback function to be called after getting the username (validateUsername() 
 * function)
 */
...
D. If the username is valid, printed the message "Valid Username!" on the console 
and called the callback function passed in the argument
...
const validateUsername = (username, callback) => {
    console.log("Validating username...");
        // if the username is not undefined or null or empty string, 
...
C. Wrote a setTimeout() function with a delay of 3 seconds to mock getting the password 
from user (assigned value "upgrad" to the password variable inside the setTimeout() function)
D. Printed the password to the console, as shown in the Problem Statement
E. Called the callback function validatePassword() while passing in the password as the 
argument to it
*/
/**
 * Function to get the password from the database
 * @param {*} callback function to be called after getting the password (validatePassword() 
 * function)
 */
...
D. If the password is valid, printed the message "Valid Password!" on the console and 
called the callback function passed in the argument
...
/*
DONE 5: Defined a function with identifier done which logs the message "BOTH VALID" 
on the console
*/
...
C. Passed validateUsername() function with username argument as the callback function 
inside the getUsername() function
D. Passed getPassword() function as the callback function inside the validateUsername() 
function
E. Passed the validatePassword() function with password argument as the callback function
 inside the getPassword() function
...
// const login = () => {
//     getUsername(username ,function() {
//         validateUsername(username, function() {
